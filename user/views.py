...
def userlogincheck(request):
    if request.method == "POST":
        ...
        try:
            ...
            status = check.status
            ('Status is = ', status)
            if str(email)==str(check.email) and str(pswd)==str(check.passwd):
...
def usersanswers(request):
    if request.method == 'POST':
        ...
        print(email, subject, question1, answer1, question2, answer2, question3, answer3, question4, answer4, question5,
              answer5, question6, answer6, question7, answer7, question8, answer8, question9, answer9, question10,
              answer10, )
        UserTestModel.objects.create(email=email, subject=subject, question1=question1, answer1=answer1,
                                     question2=question2, answer2=answer2, question3=question3, answer3=answer3,
                                     question4=question4, answer4=answer4, question5=question5, answer5=answer5,
                                     question6=question6, answer6=answer6, question7=question7,
                                     answer7=answer7, question8=question8, answer8=answer8, question9=question9,
                                     answer9=answer9, question10=question10, answer10=answer10)
